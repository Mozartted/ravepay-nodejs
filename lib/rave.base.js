...
var RaveBase = function (public_key, secret_key, base_url_or_production_flag) {
	...
	if((base_url_or_production_flag == true) || (base_url_or_production_flag === 'true')){
		console.log("rave api production status is ", base_url_or_production_flag);
		base_url = prod_url;
	}else {
		console.log(base_url_or_production_flag);
	}
